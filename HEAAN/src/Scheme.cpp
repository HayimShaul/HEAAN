...
Plaintext* Scheme::encode(double* vals, long n, long logp, long logq) {
	...
	return new Plaintext(mx, logp, logq, ring->N, n);
}
...
Plaintext* Scheme::encodeSingle(double val, long logp, long logq) {
	...
	return new Plaintext(mx, logp, logq, ring->N, 1);
}
...
Ciphertext* Scheme::encryptMsg(Plaintext* msg) {
	...
	return new Ciphertext(ax, bx, msg->logp, msg->logq, msg->N, msg->n);
}
...
Plaintext* Scheme::decryptMsg(SecretKey* secretKey, Ciphertext* cipher) {
	...
	return new Plaintext(mx, cipher->logp, cipher->logq, cipher->N, cipher->n);
}
...
Ciphertext* Scheme::negate(Ciphertext* cipher) {
	...
	return new Ciphertext(ax, bx, cipher->logp, cipher->logq, cipher->N, cipher->n);
}
...
Ciphertext* Scheme::add(Ciphertext* cipher1, Ciphertext* cipher2) {
	...
	return new Ciphertext(ax, bx, cipher1->logp, cipher1->logq, cipher1->N, cipher1->n);
}
...
Ciphertext* Scheme::mult(Ciphertext* cipher1, Ciphertext* cipher2) {
	...
	return new Ciphertext(axmult, bxmult, cipher1->logp + cipher2->logp, cipher1->logq, cipher1->N, cipher1->n);
}
...
Ciphertext* Scheme::square(Ciphertext* cipher) {
	...
	return new Ciphertext(axmult, bxmult, 2 * cipher->logp, cipher->logq, cipher->N, cipher->n);
}
...
Ciphertext* Scheme::multByConst(Ciphertext* cipher, double cnst, long logp) {
	...
	return new Ciphertext(ax, bx, cipher->logp + logp, cipher->logq, cipher->N, cipher->n);
}
...
Ciphertext* Scheme::divByPo2(Ciphertext* cipher, long bits) {
	...
	return new Ciphertext(ax, bx, cipher->logp, cipher->logq - bits, cipher->N, cipher->n);
}
...
Ciphertext* Scheme::reScaleBy(Ciphertext* cipher, long dlogq) {
	...
	return new Ciphertext(ax, bx, cipher->logp - dlogq, cipher->logq - dlogq, cipher->N, cipher->n);
}
...
Ciphertext* Scheme::reScaleTo(Ciphertext* cipher, long logq) {
	...
	return new Ciphertext(ax, bx, cipher->logp - dlogq, logq, cipher->N, cipher->n);
}
...
Ciphertext* Scheme::modDownBy(Ciphertext* cipher, long dlogq) {
	...
	return new Ciphertext(ax, bx, cipher->logp, cipher->logq - dlogq, cipher->N, cipher->n);
}
...
Ciphertext* Scheme::modDownTo(Ciphertext* cipher, long logq) {
	...
	ring->mod(ax, cipher->ax, q);
	ring->mod(bx, cipher->bx, q);
	return new Ciphertext(ax, bx, cipher->logp, logq, cipher->N, cipher->n);
}
